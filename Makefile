...
warchest: coin.o graphics.o window.o warchest.o
...
window.o: src/putty.c inc/window.h
	gcc -Wall -O2 -std=c11 -c -o obj/window.o src/putty.c

warchest.o: src/warchest.c inc/coin.h inc/graphics.h inc/types.h inc/window.h
